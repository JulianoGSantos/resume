...
<main class="container-sm flex items-stretch">
    <div class="col-6 h-96 content-center mt-20 p-10">
        <p class="fs-1">Bem-vindo,</p><br>
        <p class="fs-5">esse é meu website portifólio</p>
        <button class="col-5 btn btn-outline-secondary btn-sm border-2 shadow-md rounded-full justify-center transition ease-in-out delay-75 hover:bg-red-600 hover:scale-125 duration-300 mt-3">Meu caminho</button>
        <div class="col-5 flex justify-center mt-3 gap-2">
    ...
    <div class="col-6 h-96 content-center mt-20 p-10">
        <img src="img/portifolio.png" width="1000px" alt="setup">
    </div>
</main>
